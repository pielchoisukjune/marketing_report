...
var logic = function(){
	...
	var	_make_google_seo_list = make_google_seo_list( data.google_seo_list[ target_month ], cards_thtml )
	...
	var _statistic_google_html = make_statistic_google_html( data.google_ad_info_list[ target_month ], statistic_monthly_thtml );
	...
	var google_ages_data = make_google_ages_data( data.google_ages[ target_month ] );
    var time_data = make_time_data( data.time[ target_month ] );
	var google_time_data = make_google_time_data( data.google_time[ target_month ] );
    ...
    var report_html = report_thtml.replace(/<!=BRAND_NM=!>/g,brand_nm )
		...
		.replace( "<!=SEO_CARDS=!>",_make_google_seo_list )
		...
		.replace( "<!=GOOGLE_STATISTIC=!>",_statistic_google_html )
		...
		.replace( "<!=AGES_DATA_GOOGLE=!>",JSON.stringify( google_ages_data ) )
		.replace( "<!=TIME_DATA=!>",JSON.stringify( time_data ) )
		.replace( "<!=GOOGLE_TIME_DATA=!>",JSON.stringify( google_time_data ) )
